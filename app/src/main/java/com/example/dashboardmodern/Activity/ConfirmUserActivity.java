...
public class ConfirmUserActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (bundle != null) {
            ...
            Call<String> call = methods.sendTokenUser(username);
            ...
            btn.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View view) {
                    Call<String> confirmToken = methods.confirmTokenUser(username,txt.getText().toString());
                    confirmToken.enqueue(new Callback<String>() {
                        @Override
                        public void onResponse(Call<String> call, Response<String> response) {
                            Intent intent = new Intent(ConfirmUserActivity.this, UserLoginActivity.class);
